...
public class Choose_Coin_To_Remove extends AppCompatActivity {
            ...
            gold.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(files.size() == 0 || files.get(0).equals("")){
                        Toast.makeText(Choose_Coin_To_Remove.this, "There are no names!!", Toast.LENGTH_LONG).show();
                    }
                    else{
                        coins = "-3";
                        Intent intent = new Intent(Choose_Coin_To_Remove.this, Select_Name.class);
            ...
            other.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(files.size() == 0 || files.get(0).equals("")){
                        ...
                        coins = "-3";
                        Intent intent = new Intent(Choose_Coin_To_Remove.this, Other_Coins_remove.class);
                        intent.putExtra("coin", coins);
                        startActivity(intent);
                    }
                }
